...
def datafr():
    df= pd.read_csv("C:/Users/Godveen/Guvi/capstoneProjects/Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open("C:/Users/Godveen/Guvi/capstoneProjects/images/airbnb.jpg")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:/Users/Godveen/Guvi/capstoneProjects/Airbnb.csv")
            return df_a
